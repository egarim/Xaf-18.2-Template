...
namespace Template.Spa {
    public partial class TemplateSpaApplication : SpaApplication {
        #region Default XAF configuration options (https://www.devexpress.com/kb=T501418)
        static TemplateSpaApplication()
        {
        ...
        #endregion
        public TemplateSpaApplication() : base()
        {
            Tracing.Initialize();
        ...
        private void TemplateSpaApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e)
        {
