...
import { LogicError, AppPlayerError } from "../logic/operations";
...
export function showError(error) {
    ...
    if (typeof error === "string") {
        ...
        var stringMessage = error.details || error.message, htmlMessage = error.details || error.message;
    ...
    else if (error instanceof AppPlayerError) {
        var stringMessage = error.details || error.message, htmlMessage = error.details || error.message;
        console.error(stringMessage);
        showErrorToast(htmlMessage);
    }
