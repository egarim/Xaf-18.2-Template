...
var ViewModelHelper = /** @class */ (function () {
    ...
    ViewModelHelper.loadParameters = function (viewInfo, globalRunContext, parameterProcessor, paramNames) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, config, params, localRunContext, values_1, reason_1;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = viewInfo.routingPart, config = _a.config, params = _a.params, localRunContext = viewInfo.localRunContext;
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
    ...
    ViewModelHelper.clearModel = function (displayedViewInfo, services, runContext) {
        var $local = displayedViewInfo.localRunContext.$local, config = displayedViewInfo.routingPart.config, emptyModel = Model.createLocalModel(config, services, runContext);
        (config.model || [])
