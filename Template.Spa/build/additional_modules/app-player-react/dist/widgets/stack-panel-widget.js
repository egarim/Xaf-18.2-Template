...
import { normalizeStyle } from "./with-normalized-css-properties";
...
var ReactStackPanel = /** @class */ (function (_super) {
    ...
    ReactStackPanel.prototype.renderChildren = function (orientation, components) {
        if (components) {
            return components.map(function (componentConfig, index) { return (React.createElement(FlexCalcPropsWidgetRenderer, { key: index, widgetProps: componentConfig, orientation: orientation })); });
        }
        else {
