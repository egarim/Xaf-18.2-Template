...
var ReactDataGrid = /** @class */ (function (_super) {
    ...
    ReactDataGrid.prototype.getGridOptions = function (props) {
        var columns = props.columns, runContext = props.runContext, rest = tslib_1.__rest(props, ["columns", "runContext"]), _a = this.extractNestedOptions(rest), gridOptions = _a.gridOptions, nestedOptions = _a.nestedOptions;
        return {
    ...
    ReactDataGrid.prototype.render = function () {
        ...
        return (React.createElement(RunContext.Consumer, null, function (runContext) {
            ...
            var props = tslib_1.__assign({}, gridOptions, { defaultColumns: defaultColumns });
    ...
    ReactDataGrid.defaultProps = { columns: [] };
