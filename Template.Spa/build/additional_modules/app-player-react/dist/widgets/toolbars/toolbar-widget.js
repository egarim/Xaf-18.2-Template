...
var ReactToolbar = /** @class */ (function (_super) {
    ...
    ReactToolbar.extractWidgetOptions = function (command) {
        ...
        return { options: options, locateInMenuOptions: locateInMenuOptions, locateInMenu: locateInMenu, showText: showText, location: location, template: template, menuItemTemplate: menuItemTemplate, disabled: options.disabled };
    };
