...
export declare const ReactToolbarBaseWithTheme: React.StatelessComponent<import("../../common/base-component").VisibleProps & import("../../common/base-component").DisableProps & {
    id?: string;
    type?: string;
} & ComponentWithStyleProps & IToolbarOptions & {
    children?: React.ReactNode;
    items: ReactToolbarItem<import("../../common/base-component").VisibleProps & import("../../common/base-component").DisableProps & {
        id?: string;
        type?: string;
    } & {
        icon?: string;
...
} & import("../with-theme").ThemeProvider>;
