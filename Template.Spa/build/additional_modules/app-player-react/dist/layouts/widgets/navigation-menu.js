...
import { WithApplicationInfo } from "./with-application-info";
...
var NavigationMenu = /** @class */ (function (_super) {
    ...
    NavigationMenu.getDerivedStateFromProps = function (props, state) {
        ...
        if (prevProps.items !== props.items) {
            return { currentItem: findActiveItem(props.items), prevProps: props };
        }
        if (prevProps.compact !== props.compact) {
            return { compact: props.compact, collapsed: props.compact, prevProps: props };
        }
