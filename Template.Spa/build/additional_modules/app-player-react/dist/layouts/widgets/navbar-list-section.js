...
var NavbarListSection = /** @class */ (function (_super) {
    ...
    NavbarListSection.prototype.render = function () {
        var _this = this;
        var _a = this.props, onItemClick = _a.onItemClick, selectedItems = _a.selectedItems, rest = tslib_1.__rest(_a, ["onItemClick", "selectedItems"]), _b = rest.items[0].visible, visible = _b === void 0 ? true : _b, onItemClickFn = onItemClick || this.onItemClickSelector(this.props);
        return (React.createElement(WithStyle, { className: this.props.className }, function (_a) {
            var main = _a.main;
            return (React.createElement(List, tslib_1.__assign({}, rest, { ref: _this.ref, scrollByContent: false, scrollingEnabled: false, itemComponent: RootNavbarItem, onItemClick: onItemClickFn, selectionMode: "none", keyExpr: "viewId", visible: visible, className: main })));
        }));
    };
