...
export var Navbar = withDefaultStyle(function (props) {
    var items = props.items, selectedItem = props.selectedItem, style = props.style;
    return (React.createElement(WithStyle, null, function (_a) {
        var main = _a.main;
        return (React.createElement(ScrollView, { className: main },
            React.createElement("div", { style: style }, items.map(function (item) {
