...
var DesktopLayoutViewModel = /** @class */ (function (_super) {
    ...
    DesktopLayoutViewModel.prototype.render = function () {
        var _a = this.props, globalCommands = _a.globalCommands, children = _a.children, runContext = _a.runContext, displayedViewsInfo = _a.displayedViewsInfo;
        return children(this.createDesktopLayoutViewModel(displayedViewsInfo, globalCommands, runContext));
    };
    DesktopLayoutViewModel.prototype.createDesktopLayoutViewModel = function (displayedViewsInfo, commands, runContext) {
        ...
        return {
            rendered: false,
            globalToolbar: {
                items: globalToolbarItemsSelector({ commands: commands, runContext: runContext })
            },
            mainPane: {
                visible: true,
                name: "main",
