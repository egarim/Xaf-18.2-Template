...
import { getImediatePostDataPropertyGetterSetter, applayAppConfigDiff } from "./common";
...
var viewStateParameter = {
    ...
    customProcess: function (_a) {
        ...
        var viewState = response.viewState, currentObject = viewState.currentObject, configDiffs = viewState.configDiffs;
