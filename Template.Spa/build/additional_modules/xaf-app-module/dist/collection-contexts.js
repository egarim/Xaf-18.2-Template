...
export var createListView$codeFunctions = function (propertyName) {
    ...
    return {
        ...
        getViewState: function (_a) {
            var $local = _a.$local;
            var _b = $local[baseModelProperty.viewState].objectsState, objectsState = _b === void 0 ? null : _b;
            return tslib_1.__assign({}, collectionContextFn($local)[baseModelProperty.viewState], { objectsState: objectsState });
        },
