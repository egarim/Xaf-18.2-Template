...
export function getListViewListWidget(_a) {
    ...
    }, propertyName = dataSource && dataSource.propertyName, keyPropertyName = "Oid", action = getActionExecute({ actionId: listViewShowObjectAction, propertyName: propertyName, keyPropertyName: keyPropertyName }), _$codeFunctions = createListView$codeFunctions(propertyName), result = collectionWidgetOptions(tslib_1.__assign({}, listComponentBase, { dataSource: dataSource,
