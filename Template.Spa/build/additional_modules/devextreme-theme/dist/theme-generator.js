...
var defaultColors = {
    ...
    "light": {
        less: function () { return import("../less/theme-builder-generic-light.less"); },
        css: function () { return require("devextreme/dist/css/dx.light.css"); },
    },
    "light-compact": {
        less: function () { return import("../less/theme-builder-generic-light-compact.less"); },
        css: function () { return require("devextreme/dist/css/dx.light.compact.css"); }
    }
};
var ThemeGenerator = /** @class */ (function () {
    ...
    ThemeGenerator.applyTheme = function (appConf) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var themeName, less_1, css, style;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!appConf) return [3 /*break*/, 4];
                        themeName = appConf.theme.themeName || "light";
                        return [4 /*yield*/, themeResources[themeName].css()];
                    case 1:
                        _a.sent(); // css should be applied before less file; less override some css styles;
                        return [4 /*yield*/, themeResources[themeName].less()];
                    case 2:
                        less_1 = _a.sent();
                        return [4 /*yield*/, this.getFullCss(appConf.theme, less_1.default)];
                    case 3:
                        css = _a.sent();
                        if (css) {
    ...
    ThemeGenerator.getFullCss = function (baseTheme, themeLess) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        fullBaseTheme_1 = this.getFullBaseTheme(baseTheme), themeList = themeScopes.map(function (_a) {
                            ...
                            return ({ name: name, less: _this.getLess(themeLess + themePatch, tslib_1.__assign({}, fullBaseTheme_1, theme), name) });
                        });
    ...
    ThemeGenerator.getLess = function (themeLess, theme, name) {
        var colors = this.getLessColors(theme), less = name ? "." + name + " { " + (themeLess + colors) + " } ." + name + "-replacement:extend(." + name + " all) {}" : themeLess + colors;
        return less;
    };
